...
public class TodoCtrl {
	...
	public static void main(String[] args) {
		 ...
		 */
		App.todomvc.controller("TodoCtrl",
				new Callback4<TodoScope, Location, TodoStorage, Function2<Array<Todo>, Todo, Array<Todo>>>() {
					@Override
					@Template("invoke")
					public void $invoke(final TodoScope $scope, Location $location, final TodoStorage todoStorage,
						...
						$scope.clearCompletedTodos = new Callback0() {
							public void $invoke() {
								$scope.todos = $scope.todos
										.filter(new Function3<Todo, Integer, ArrayExtra<Todo>, Boolean>() {
